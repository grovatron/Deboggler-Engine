...
public class OriginalDebogglerExample {
	...
	public static void main(String[] args) throws IOException {
		...
		/**
		 * Build a WordConstructor that uses the OriginalPointCalculator.
		 * The OriginalPointCalculator uses the original Boggle rules to generate 
		 ...
		 * The original Boggle rules specifies that the minimum word length is 3.
		 */
		int minLength = 3;
